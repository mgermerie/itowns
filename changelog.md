<a name="2.39.0"></a>
# [2.39.0](https://github.com/iTowns/itowns/compare/v2.38.2...v2.39.0) (2022-12-05)
...
* release v2.39.0 ([bc018d4](https://github.com/iTowns/itowns/commit/bc018d4))
...
* **integration:** differentiate deployment for LTS and current version ([177f4e1](https://github.com/iTowns/itowns/commit/177f4e1))
* **integration:** publish latest and next npm packages ([b4f5a5d](https://github.com/iTowns/itowns/commit/b4f5a5d))
...
* [test]: changelog ([f84afb2](https://github.com/iTowns/itowns/commit/f84afb2))
* [TEMP] test publication and deployment on personal repos ([726843f](https://github.com/iTowns/itowns/commit/726843f))
