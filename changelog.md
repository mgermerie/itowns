<a name="2.47.1-next.1"></a>
## [2.47.1-next.1](https://github.com/mgermerie/itowns/compare/v2.44.0...v2.47.1-next.1) (2026-01-09)


### Features

* **3d-tiles:** support picking of metadata ([031f93e](https://github.com/mgermerie/itowns/commit/031f93e))
* **3dtiles:** add deprecation warning to C3DTilesLayer. Use OGC3DTilesLayer instead ([cbfd1bb](https://github.com/mgermerie/itowns/commit/cbfd1bb))
* **3dtiles:** add tiles-load-start and tiles-load-end events ([3d89169](https://github.com/mgermerie/itowns/commit/3d89169))
* **3dtiles:** update 3d-tiles-renderer to 0.3.39 ([565ba36](https://github.com/mgermerie/itowns/commit/565ba36))
* add `enableMeshoptDecoder` function for GLTFs ([3a9784c](https://github.com/mgermerie/itowns/commit/3a9784c))
* Add gamma and ambient boost option for Point Shader ([#2550](https://github.com/mgermerie/itowns/issues/2550)) ([f1b6761](https://github.com/mgermerie/itowns/commit/f1b6761))
* add publiccode ([#2417](https://github.com/mgermerie/itowns/issues/2417)) ([cfb9d0f](https://github.com/mgermerie/itowns/commit/cfb9d0f))
...
* **ci:** bump node to next LTS (v22) ([#2452](https://github.com/mgermerie/itowns/issues/2452)) ([8df42d2](https://github.com/mgermerie/itowns/commit/8df42d2))
* **controls:** add state controls at view init ([868889f](https://github.com/mgermerie/itowns/commit/868889f))
* **controls:** disabled multi actions when zooming ([89bbbd8](https://github.com/mgermerie/itowns/commit/89bbbd8))
* deprecate Coordinates constructor with array and vector3 ([efe9c58](https://github.com/mgermerie/itowns/commit/efe9c58))
* **deps:** bump proj4 from 2.9.3 to 2.9.10 ([16cf342](https://github.com/mgermerie/itowns/commit/16cf342))
* **eslint:** remove preference for default export ([#2447](https://github.com/mgermerie/itowns/issues/2447)) ([4e7bcd2](https://github.com/mgermerie/itowns/commit/4e7bcd2))
* **example:** 3dTilesLoader, parse url search-param query ([adecc81](https://github.com/mgermerie/itowns/commit/adecc81))
* export type definitions for the itowns package ([f256f47](https://github.com/mgermerie/itowns/commit/f256f47))
* **Extent:** add setFromArray and setFromExtent methods ([856bb88](https://github.com/mgermerie/itowns/commit/856bb88))
* **geographic:** let user import single modules ([f160270](https://github.com/mgermerie/itowns/commit/f160270))
* **geography:** enable type definitions distribution ([8c0e8c3](https://github.com/mgermerie/itowns/commit/8c0e8c3))
* **globeControls:** zoom on mouse position while using wheel ([85ce178](https://github.com/mgermerie/itowns/commit/85ce178))
* **index.html:** auto-redirect to examples ([#2478](https://github.com/mgermerie/itowns/issues/2478)) ([1e171ff](https://github.com/mgermerie/itowns/commit/1e171ff))
* **Layer:** add startup lifecycle method ([35935c7](https://github.com/mgermerie/itowns/commit/35935c7))
* **Main:** add tsc command to generate types for typescript integration ([#2552](https://github.com/mgermerie/itowns/issues/2552)) ([fc2694a](https://github.com/mgermerie/itowns/commit/fc2694a))
* **MVT:** change mapBox package to mapLib ([b81e8e9](https://github.com/mgermerie/itowns/commit/b81e8e9))
...
* **PointMaterial:** force transparent to true (instead of needTransparency) and depthWrite to false + add Visibility Texture ([ed09804](https://github.com/mgermerie/itowns/commit/ed09804))
* **renderer:** pack textures in texture arrays to reduce number of texture slots per layer ([b46b807](https://github.com/mgermerie/itowns/commit/b46b807))
...
* **VectorTile:** add support for relative url in style ([09f7adb](https://github.com/mgermerie/itowns/commit/09f7adb))
* **Vpc:** add VpcSource/Layer as COPC or EPT MultiSource/Layer ([ebbdfa0](https://github.com/mgermerie/itowns/commit/ebbdfa0))
* **VR:** add control event ([a6c9136](https://github.com/mgermerie/itowns/commit/a6c9136))
* **webXR:** implement controllers support ([deebca2](https://github.com/mgermerie/itowns/commit/deebca2))
* **wms:** use proj4 crs axis param ([7d67ec4](https://github.com/mgermerie/itowns/commit/7d67ec4))


### Bug Fixes

* **3dtiles:** add layer to object returned by OGC3DTilesLayer.pickObjectsAt ([25467e5](https://github.com/mgermerie/itowns/commit/25467e5))
* **3DTiles:** correctly handle all layer config (e.g. layer name) ([0acb0a4](https://github.com/mgermerie/itowns/commit/0acb0a4))
* **3dtiles:** handle multiple 3dtiles ([12af9a1](https://github.com/mgermerie/itowns/commit/12af9a1))
* **3dtiles:** support point cloud attenuated mode in OGC3DTiles layer ([afcb250](https://github.com/mgermerie/itowns/commit/afcb250))
* add nosetter ([0ec1ec2](https://github.com/mgermerie/itowns/commit/0ec1ec2))
* add required name in package.json for yarn ([ac5f830](https://github.com/mgermerie/itowns/commit/ac5f830))
* add some unit tests ([5fbf3c3](https://github.com/mgermerie/itowns/commit/5fbf3c3))
* **Atmosphere:** add RenderOrder to basic- and realistic- Atmosphere meshes ([5143311](https://github.com/mgermerie/itowns/commit/5143311))
* **Atmosphere:** double luminance declaration ([1fa5a5a](https://github.com/mgermerie/itowns/commit/1fa5a5a))
* **Atmosphere:** set tile atmosphere uniforms ([fb8aa9c](https://github.com/mgermerie/itowns/commit/fb8aa9c)), closes [#2477](https://github.com/mgermerie/itowns/issues/2477)
* **babel:** include ts files in prerequisites ([eb73b45](https://github.com/mgermerie/itowns/commit/eb73b45))
* **C3DTilesLayer:** updateStyle works with new style API ([a4f0d22](https://github.com/mgermerie/itowns/commit/a4f0d22))
...
* change document.location -> import.meta.url ([#2590](https://github.com/mgermerie/itowns/issues/2590)) ([6662fc5](https://github.com/mgermerie/itowns/commit/6662fc5))
* **ci:** fix missing env variable for release ([e548cf0](https://github.com/mgermerie/itowns/commit/e548cf0))
* **ci:** revert convential-changelog from 5.0.0 to 4.1.0 ([58595f6](https://github.com/mgermerie/itowns/commit/58595f6)), closes [#2511](https://github.com/mgermerie/itowns/issues/2511)
* **Cog-Geotiff:** Fix tile raster dimensions ([3fedcae](https://github.com/mgermerie/itowns/commit/3fedcae))
* **COG:** Fix extent in COG parser ([452ca7e](https://github.com/mgermerie/itowns/commit/452ca7e))
* **Crs:** add 'ft' as possible unit ([01dedb6](https://github.com/mgermerie/itowns/commit/01dedb6))
* **Crs:** correctly renamed reasonableEpsilon function ([205c27f](https://github.com/mgermerie/itowns/commit/205c27f))
* **crs:** fix proj4 unit 'meter' and add 'foot' ([07c3f63](https://github.com/mgermerie/itowns/commit/07c3f63))
* **doc:** fix doc generation error ([fc2d3ab](https://github.com/mgermerie/itowns/commit/fc2d3ab))
...
* **docs:** fix error in config file ([56aae0a](https://github.com/mgermerie/itowns/commit/56aae0a))
* **elevation:** fix non-disposed raster tile ([f9cdab7](https://github.com/mgermerie/itowns/commit/f9cdab7))
...
* **eslint:** allow useless constructors in TS ([#2520](https://github.com/mgermerie/itowns/issues/2520)) ([6ce9e81](https://github.com/mgermerie/itowns/commit/6ce9e81))
* **exampleCOPC:** fix elevation behavior ([95d2194](https://github.com/mgermerie/itowns/commit/95d2194))
* **example:** fix copc_simple_loader example ([adc7d7b](https://github.com/mgermerie/itowns/commit/adc7d7b))
* **examples:** add envmap for PBR materials in 3d tiles loader example ([8b22591](https://github.com/mgermerie/itowns/commit/8b22591))
* **examples:** fix broken copc loader example ([b63980b](https://github.com/mgermerie/itowns/commit/b63980b))
* **examples:** fix linked with zoom properties well used ([d947233](https://github.com/mgermerie/itowns/commit/d947233))
* **examples:** update potrees examples to lil-gui ([691750d](https://github.com/mgermerie/itowns/commit/691750d))
* **fetcher:** add sanity check for texture data ([8799e81](https://github.com/mgermerie/itowns/commit/8799e81))
* **fetcher:** improve image loading error log ([dc347d1](https://github.com/mgermerie/itowns/commit/dc347d1))
* Fix monorepo typescript issues ([88aea43](https://github.com/mgermerie/itowns/commit/88aea43))
* fix wrong install path for dependencies ([c6f5964](https://github.com/mgermerie/itowns/commit/c6f5964))
* **GlobeView:** remove default directional light ([0a098af](https://github.com/mgermerie/itowns/commit/0a098af))
* **i3dm:** use instanceId to get info ([683e55d](https://github.com/mgermerie/itowns/commit/683e55d))
* **LabelLayer:** gestion simplified of line and polygon Label ([cb3c3b7](https://github.com/mgermerie/itowns/commit/cb3c3b7))
* **Label:** Multiple labels with same textContent ([a2cfd3a](https://github.com/mgermerie/itowns/commit/a2cfd3a))
* **layers:** per material uniform setting ([90159bd](https://github.com/mgermerie/itowns/commit/90159bd))
* **material:** set transparency when some points classes are disabled ([f26f050](https://github.com/mgermerie/itowns/commit/f26f050))
* **MVTLayers:** add MVTLayer where MVTStyle.layer has 'ref' properties ([497ac8c](https://github.com/mgermerie/itowns/commit/497ac8c))
* **MVTParser:** supp use of layer.style.zoom in parser ([6b0e287](https://github.com/mgermerie/itowns/commit/6b0e287))
* **MVTStyle:** Doing recoloring only with sdf icons. ([11d10ea](https://github.com/mgermerie/itowns/commit/11d10ea))
* **MVTStyle:** icon properties -> fix return of function when id includes {} ([fffecc9](https://github.com/mgermerie/itowns/commit/fffecc9))
* **OGC3DTilesLayer:** handle multiple views ([#2435](https://github.com/mgermerie/itowns/issues/2435)) ([b991878](https://github.com/mgermerie/itowns/commit/b991878))
* **OrientationUtils:** add all lcc aliases ([d741e14](https://github.com/mgermerie/itowns/commit/d741e14))
* **OrientationUtils:** add UTM support ([b5b6e9a](https://github.com/mgermerie/itowns/commit/b5b6e9a))
* **OrientationUtils:** upgrade ts type to proj4 2.19.3 ([c103328](https://github.com/mgermerie/itowns/commit/c103328))
* **package:** fix peerDeps issues when bumping version ([b380897](https://github.com/mgermerie/itowns/commit/b380897))
* **Parser:** wrong chunk name for worker ([2516c1f](https://github.com/mgermerie/itowns/commit/2516c1f))
* **Picking:** Fix traversePickingCircle for pickPointsAt ([d343727](https://github.com/mgermerie/itowns/commit/d343727))
* **Picking:** No geometry or unloaded points should not be taken for picking ([83b9d70](https://github.com/mgermerie/itowns/commit/83b9d70))
...
* **PointCloud:** Fix clipping point cloud ([2019826](https://github.com/mgermerie/itowns/commit/2019826))
* **pointcloud:** Fix point cloud distance to camera whatever point cloud initial placement is ([ff9a86a](https://github.com/mgermerie/itowns/commit/ff9a86a))
* **PointCloudLayer:** move debug functions to Debug/PointCloudDebug ([43eaeaf](https://github.com/mgermerie/itowns/commit/43eaeaf))
* **PointCloudLayer:** use the User value for ElevationRange (if present) ([387d64f](https://github.com/mgermerie/itowns/commit/387d64f))
...
* post-review comments ([d1a7186](https://github.com/mgermerie/itowns/commit/d1a7186))
...
* **potree:** Fix incorrectly built points URL ([1ba02ee](https://github.com/mgermerie/itowns/commit/1ba02ee))
* **publiccode.yml:** fix the logo URL ([822c63b](https://github.com/mgermerie/itowns/commit/822c63b))
* **RasterTile:** fix deepScan issues ([b395a75](https://github.com/mgermerie/itowns/commit/b395a75))
* **RasterTile:** partial loading for raster tiles ([05c3a0e](https://github.com/mgermerie/itowns/commit/05c3a0e))
* **RasterTile:** remove unnecessary material reference ([840d42f](https://github.com/mgermerie/itowns/commit/840d42f))
* **renderer:** Remove custom fog shader to support standard Three fog ([3c5881b](https://github.com/mgermerie/itowns/commit/3c5881b))
* **renderer:** restore renderer/VR state after texture rendering ([7277c52](https://github.com/mgermerie/itowns/commit/7277c52))
* **RenderMode:** change material.transparent to true when rendering mode is Final ([651c88a](https://github.com/mgermerie/itowns/commit/651c88a))
* **review:** use the alias names list of proj4 ([0da7ce5](https://github.com/mgermerie/itowns/commit/0da7ce5))
* **source:** support urls already containing query parameters for wms, wmts, and wfs ([4f53025](https://github.com/mgermerie/itowns/commit/4f53025))
* **Style:** cropValueDefault ([fe68e41](https://github.com/mgermerie/itowns/commit/fe68e41))
* **Style:** Don't draw Polygon when fill.color is undefined ([21b0900](https://github.com/mgermerie/itowns/commit/21b0900))
* **Style:** Don't draw stroke when width is 0 ([b8a13d9](https://github.com/mgermerie/itowns/commit/b8a13d9))
* **Style:** dont draw icon when size is 0 ([858b89e](https://github.com/mgermerie/itowns/commit/858b89e))
* **Style:** take style.zoom into account for LabelLayer and Feature2Texture ([5ec037b](https://github.com/mgermerie/itowns/commit/5ec037b))
* **subdivision:** Remove the subdividing condition in the update strategy ([#2522](https://github.com/mgermerie/itowns/issues/2522)) ([2c5c086](https://github.com/mgermerie/itowns/commit/2c5c086))
* **terrain:** fix depth & transparency issues ([564cb06](https://github.com/mgermerie/itowns/commit/564cb06))
* **Terrain:** fix terrain subdivision when a terrain tile only has values that should be clamped ([cb96727](https://github.com/mgermerie/itowns/commit/cb96727))
* **test:** add test for CRS.defsFromWkt() ([86bbbbb](https://github.com/mgermerie/itowns/commit/86bbbbb))
* **test:** entwine Node ([0e45990](https://github.com/mgermerie/itowns/commit/0e45990))
* **test:** expose variables for functional tests ([350e3b1](https://github.com/mgermerie/itowns/commit/350e3b1))
* **test:** fix local unit tests behind proxy ([9b9d52a](https://github.com/mgermerie/itowns/commit/9b9d52a))
* **test:** increase time out ([bfdebca](https://github.com/mgermerie/itowns/commit/bfdebca))
* **test:** node 22.18 breaks npm package ([737a8f3](https://github.com/mgermerie/itowns/commit/737a8f3))
* **tests:** re set --no-sandbox ([c4629d6](https://github.com/mgermerie/itowns/commit/c4629d6))
* **test:** tempory disable clamp ground test because data server is down ([4ee3c7f](https://github.com/mgermerie/itowns/commit/4ee3c7f))
...
* **TileBuilder:** use cached buffers correctly ([#2491](https://github.com/mgermerie/itowns/issues/2491)) ([f3d2e90](https://github.com/mgermerie/itowns/commit/f3d2e90))
* **TiledGeometryLayer:** remove subdivision checking code ([#2344](https://github.com/mgermerie/itowns/issues/2344)) ([e386637](https://github.com/mgermerie/itowns/commit/e386637))
* **TiledGeometryLayer:** replace get data by the new getPropertyArray ([ec665c3](https://github.com/mgermerie/itowns/commit/ec665c3))
* **TiledGeometryLayer:** set autoRefreshToken to true ([ebf37dd](https://github.com/mgermerie/itowns/commit/ebf37dd))
* **TileLayer:** fix material opacity ([71fa255](https://github.com/mgermerie/itowns/commit/71fa255))
* **TileLayer:** transparence set to true by default ([54a4fce](https://github.com/mgermerie/itowns/commit/54a4fce))
* **tutorials:** use OGC3DTilesLayer in 3d tiles tutorials ([e345979](https://github.com/mgermerie/itowns/commit/e345979))
* **types:** resolve absolute imports to relative paths in .d.ts ([bf93558](https://github.com/mgermerie/itowns/commit/bf93558))
* use a fresh page when loading an example ([ca60dfe](https://github.com/mgermerie/itowns/commit/ca60dfe))
* **VectorTile:** fix {z}/{y}/{x} ([9250fd8](https://github.com/mgermerie/itowns/commit/9250fd8))
* **VectorTile:** supp order in Style as it's only a Label properties in VT ([3dc135e](https://github.com/mgermerie/itowns/commit/3dc135e))
* **VPC:** reprojection for VPC layer ([e05324e](https://github.com/mgermerie/itowns/commit/e05324e))
* **wms:** assign axis order param from source ([aec3ebf](https://github.com/mgermerie/itowns/commit/aec3ebf))
* **wms:** take wms 1.1.1 version into account for axis order ([0499f95](https://github.com/mgermerie/itowns/commit/0499f95))
* **xbilparser:** apply zmin / zmax for any texture subsampling size ([745ab2c](https://github.com/mgermerie/itowns/commit/745ab2c))
* **Zoom:** use zoom state ([426fe29](https://github.com/mgermerie/itowns/commit/426fe29))


### Examples

* **3DTiles:** create an only 3D tiles example that can load any 3D tiles ([3eb7a23](https://github.com/mgermerie/itowns/commit/3eb7a23))
* **3DTiles:** fix function naming error ([2ca0505](https://github.com/mgermerie/itowns/commit/2ca0505))
* add copc_3d_loader to example menu ([628f03e](https://github.com/mgermerie/itowns/commit/628f03e))
* **MVT:** add example with official MapBox style file ([d1abe5a](https://github.com/mgermerie/itowns/commit/d1abe5a))
* **PointCloud:** fix errors ([8dc71f9](https://github.com/mgermerie/itowns/commit/8dc71f9))
...
* **cache:** use LRUCache instead of own cache ([6d12fde](https://github.com/mgermerie/itowns/commit/6d12fde))
* **CopcSource:** use metadata.wkt to set source.crs ([69ed2f4](https://github.com/mgermerie/itowns/commit/69ed2f4))
* **Crs:** cleanup unit handling ([ea397ee](https://github.com/mgermerie/itowns/commit/ea397ee))
* **Crs:** remove tms/epsg family of functions ([83eb0d9](https://github.com/mgermerie/itowns/commit/83eb0d9))
* **Crs:** rename toUnit to getUnit ([2fdf15a](https://github.com/mgermerie/itowns/commit/2fdf15a))
* **Crs:** use named exports instead of default export ([fca5a29](https://github.com/mgermerie/itowns/commit/fca5a29))
* **entwineSource:** read crs from metadata.srs ([1ecc6aa](https://github.com/mgermerie/itowns/commit/1ecc6aa))
...
* **LayeredMaterial:** migrate to TypeScript ([#2477](https://github.com/mgermerie/itowns/issues/2477)) ([22b875d](https://github.com/mgermerie/itowns/commit/22b875d))
* **Layer:** move mergeFeatures up ([656872c](https://github.com/mgermerie/itowns/commit/656872c))
* **Layer:** move strat up ([e1a8911](https://github.com/mgermerie/itowns/commit/e1a8911))
* **Layer:** remove Object.assign of config ([cf41e8d](https://github.com/mgermerie/itowns/commit/cf41e8d))
* migrate Coordinates to typescript ([ec79573](https://github.com/mgermerie/itowns/commit/ec79573))
* migrate Crs to typescript ([d884ba6](https://github.com/mgermerie/itowns/commit/d884ba6))
* migrate Ellipsoid to typescript ([a3fb6c5](https://github.com/mgermerie/itowns/commit/a3fb6c5))
* migrate Extent to typescript ([1c41e93](https://github.com/mgermerie/itowns/commit/1c41e93))
* migrate LayerUpdateState to typescript ([524bba6](https://github.com/mgermerie/itowns/commit/524bba6))
* migrate OBB to typescript ([7aaf134](https://github.com/mgermerie/itowns/commit/7aaf134))
* migrate Tile to typescript ([ac93bfd](https://github.com/mgermerie/itowns/commit/ac93bfd))
* migrate TileMesh to typescript ([31a364f](https://github.com/mgermerie/itowns/commit/31a364f))
* move addLabelLayer to ColorLayer ([15e0f38](https://github.com/mgermerie/itowns/commit/15e0f38))
* move ImageryLayers in its own module ([c37563b](https://github.com/mgermerie/itowns/commit/c37563b))
* move style property up ([45a1132](https://github.com/mgermerie/itowns/commit/45a1132))
* **MVTParser:** 1 feature per vtfeature ([25db866](https://github.com/mgermerie/itowns/commit/25db866))
* **PointCloudExamples:** move to lil gui ([cfae5dc](https://github.com/mgermerie/itowns/commit/cfae5dc))
* **PointCloud:** factorize load method ([90b3f01](https://github.com/mgermerie/itowns/commit/90b3f01))
* **PointCloudLayer:** delete onPointsCreated callback ([628ed94](https://github.com/mgermerie/itowns/commit/628ed94))
* **PointCloudLayer:** homogeneisation and move createChildAABB() to parent ([1ed7e79](https://github.com/mgermerie/itowns/commit/1ed7e79))
* **PointCloudLayer:** move layer.spacing to node.pointSpacing ([8f93b67](https://github.com/mgermerie/itowns/commit/8f93b67))
* **PointCloudLayer:** move spacing from Source to Layer ([9251665](https://github.com/mgermerie/itowns/commit/9251665))
* **PointCloudLayer:** promise.catch/finally instead of then(CallBack, errCallBack) ([b2bcb7f](https://github.com/mgermerie/itowns/commit/b2bcb7f))
* **PointCloudNode:** methode load() ([fb56b76](https://github.com/mgermerie/itowns/commit/fb56b76))
* **PointCloudNode:** move depth to Parent Class ([97165e2](https://github.com/mgermerie/itowns/commit/97165e2))
* **PointCloudNode:** move pointSpacing to PointCloudNode ([6a42dfe](https://github.com/mgermerie/itowns/commit/6a42dfe))
...
* **PointCloudNode:** rename id as voxelKey (copc and ept) and as hierarchyKey for Potree (1 & 2) ([ea4f882](https://github.com/mgermerie/itowns/commit/ea4f882))
* **Potree2Node:** Potree2Node as child of PotreeNode ([5035d34](https://github.com/mgermerie/itowns/commit/5035d34))
* **PotreeNodes:** add index as property of the node ([ac15109](https://github.com/mgermerie/itowns/commit/ac15109))
* **PotreeNode:** simplification ([685fdb5](https://github.com/mgermerie/itowns/commit/685fdb5))
...
* split Extent between geographic/tiled ([4b57498](https://github.com/mgermerie/itowns/commit/4b57498))
* **StyleOptions:** move StyleOptions from Style to its own file ([fdd2bd9](https://github.com/mgermerie/itowns/commit/fdd2bd9))
* **test:** change timeout ([327b914](https://github.com/mgermerie/itowns/commit/327b914))
* **TileBuilder:** migrate to TypeScript ([#2440](https://github.com/mgermerie/itowns/issues/2440)) ([3207dcd](https://github.com/mgermerie/itowns/commit/3207dcd))
* URLBuilder as pure functions ([8ba1376](https://github.com/mgermerie/itowns/commit/8ba1376))
* **VectorTileParser:** cleanup ([fdf4b0a](https://github.com/mgermerie/itowns/commit/fdf4b0a))


### Workflow and chores

* release v2.47.0 ([ce0bd72](https://github.com/mgermerie/itowns/commit/ce0bd72))
* release v2.46.0 ([b538924](https://github.com/mgermerie/itowns/commit/b538924))
* release v2.45.1 ([55e88dd](https://github.com/mgermerie/itowns/commit/55e88dd))
* release v2.45.0 ([6bda4f5](https://github.com/mgermerie/itowns/commit/6bda4f5))
* release v2.44.2 ([c1409c5](https://github.com/mgermerie/itowns/commit/c1409c5))
* release v2.44.1 ([fde5fb9](https://github.com/mgermerie/itowns/commit/fde5fb9))
* **3dtiles:** add more unit tests ([a923f1f](https://github.com/mgermerie/itowns/commit/a923f1f))
* add discord badge and invite link ([66b46d5](https://github.com/mgermerie/itowns/commit/66b46d5))
* **architecture:** monorepo structure ([3103718](https://github.com/mgermerie/itowns/commit/3103718))
* build to esm module ([00ca223](https://github.com/mgermerie/itowns/commit/00ca223))
* **ci:** fix deprecated set-output syntax ([9428cf0](https://github.com/mgermerie/itowns/commit/9428cf0))
* **ci:** use gh cli instead of deprecated actions ([5bda83e](https://github.com/mgermerie/itowns/commit/5bda83e))
...
* **Crs:** update and refine documentation ([d467a29](https://github.com/mgermerie/itowns/commit/d467a29))
* **deps-dev:** bump http-proxy-middleware from 2.0.7 to 2.0.9 ([2fae44b](https://github.com/mgermerie/itowns/commit/2fae44b))
...
* **deps-dev:** bump tar-fs from 3.0.8 to 3.0.9 ([182cb7d](https://github.com/mgermerie/itowns/commit/182cb7d))
* **deps-dev:** bump tar-fs from 3.0.9 to 3.1.1 ([b7d784a](https://github.com/mgermerie/itowns/commit/b7d784a))
* **deps-dev:** bump undici from 7.2.0 to 7.2.3 ([f01365d](https://github.com/mgermerie/itowns/commit/f01365d))
* **deps-dev:** bump undici from 7.4.0 to 7.5.0 ([a39544c](https://github.com/mgermerie/itowns/commit/a39544c))
* **deps-dev:** bump webpack-dev-server from 5.2.0 to 5.2.1 ([8e3e3b2](https://github.com/mgermerie/itowns/commit/8e3e3b2))
* **deps:** bump [@babel](https://github.com/babel)/runtime from 7.25.6 to 7.26.10 ([9cb6b0d](https://github.com/mgermerie/itowns/commit/9cb6b0d))
* **deps:** bump [@tweenjs](https://github.com/tweenjs)/tween.js from 23.1.2 to 25.0.0 ([63e2194](https://github.com/mgermerie/itowns/commit/63e2194))
* **deps:** bump 3d-tiles-renderer from 0.3.37 to 0.3.38 ([837c044](https://github.com/mgermerie/itowns/commit/837c044))
* **deps:** bump 3d-tiles-renderer from 0.3.39 to 0.4.4 ([e75fbb8](https://github.com/mgermerie/itowns/commit/e75fbb8))
* **deps:** bump actions/download-artifact in /.github/workflows ([8e872be](https://github.com/mgermerie/itowns/commit/8e872be))
* **deps:** bump body-parser and express ([a01de04](https://github.com/mgermerie/itowns/commit/a01de04))
* **deps:** bump cookie and express ([f602ac7](https://github.com/mgermerie/itowns/commit/f602ac7))
* **deps:** bump developer dependencies ([4bcdcb6](https://github.com/mgermerie/itowns/commit/4bcdcb6))
* **deps:** bump developer dependencies ([4d034b5](https://github.com/mgermerie/itowns/commit/4d034b5))
* **deps:** bump nanoid from 3.3.7 to 3.3.8 ([09a016f](https://github.com/mgermerie/itowns/commit/09a016f))
* **deps:** bump on-headers and compression ([8924e73](https://github.com/mgermerie/itowns/commit/8924e73))
* **deps:** bump proj4 from 2.11.0 to 2.12.1 ([804c65f](https://github.com/mgermerie/itowns/commit/804c65f))
* **deps:** bump shpjs from 6.0.1 to 6.1.0 ([4937064](https://github.com/mgermerie/itowns/commit/4937064))
* **deps:** bump three from 0.165.0 to 0.168.0 ([f7303de](https://github.com/mgermerie/itowns/commit/f7303de))
* **deps:** bump three from 0.168.0 to 0.170.0 ([ffe89c7](https://github.com/mgermerie/itowns/commit/ffe89c7))
* **deps:** remove node-fetch from dev dependencies ([1d9ffe9](https://github.com/mgermerie/itowns/commit/1d9ffe9))
* **Ellipsoid:** add method return types ([fe189be](https://github.com/mgermerie/itowns/commit/fe189be))
* **eslint:** add no-use-before-define and change max-len rules ([f8021b4](https://github.com/mgermerie/itowns/commit/f8021b4))
* **eslint:** update config to support TypeScript ([0d6b611](https://github.com/mgermerie/itowns/commit/0d6b611))
* **Extent:** deprecate array and extent constructor parameters ([1d72b64](https://github.com/mgermerie/itowns/commit/1d72b64))
* **Extent:** remove deprecated methods ([5d0c8d8](https://github.com/mgermerie/itowns/commit/5d0c8d8))
* fix dependency vulnerabilities ([29dfc60](https://github.com/mgermerie/itowns/commit/29dfc60))
* fix imports ([d31f1d2](https://github.com/mgermerie/itowns/commit/d31f1d2))
* fix publish npm package ([1496c96](https://github.com/mgermerie/itowns/commit/1496c96))
* **geographic:** mark module-levels function as pure ([872baed](https://github.com/mgermerie/itowns/commit/872baed))
* **Geographic:** upgrade Crs, Coordinates and Extent to new def types in proj4 2.19.3 ([fecc1f0](https://github.com/mgermerie/itowns/commit/fecc1f0))
...
* migrate CoordStars to typescript ([cf55d96](https://github.com/mgermerie/itowns/commit/cf55d96))
* migrate LayerUpdateStrategy to typescript ([f740b72](https://github.com/mgermerie/itowns/commit/f740b72))
* migrate OrientationUtils to typescript ([14d4812](https://github.com/mgermerie/itowns/commit/14d4812))
* **node:** update to node 24 ([d01b83f](https://github.com/mgermerie/itowns/commit/d01b83f))
* **OrientationUtils:** use function exports instead of default export ([2be8afe](https://github.com/mgermerie/itowns/commit/2be8afe))
...
* **proj4:** upgrade to 2.19.3 ([ea45788](https://github.com/mgermerie/itowns/commit/ea45788))
* remove istanbul and editor comments ([#2479](https://github.com/mgermerie/itowns/issues/2479)) ([c975752](https://github.com/mgermerie/itowns/commit/c975752))
* test oidc ([90be1d3](https://github.com/mgermerie/itowns/commit/90be1d3))
...
* **typescript:** add support for __DEBUG__ and glsl imports ([3c1bb1c](https://github.com/mgermerie/itowns/commit/3c1bb1c))
* update babel and webpack configs to support TypeScript ([8830d6d](https://github.com/mgermerie/itowns/commit/8830d6d))
* update caniuse-lite ([e9c0786](https://github.com/mgermerie/itowns/commit/e9c0786))
* update examples to module esm ([40ecb0b](https://github.com/mgermerie/itowns/commit/40ecb0b))
* update to three v182 ([bbd11b5](https://github.com/mgermerie/itowns/commit/bbd11b5))
* update vulnerable dev dependencies ([b95035b](https://github.com/mgermerie/itowns/commit/b95035b))
* use jsm three addons directly ([ec288de](https://github.com/mgermerie/itowns/commit/ec288de))


### Documentation

* **3DTiles:** Replace C3DTilesLayer by OGC3DTilesLayer in the documentation ([0491983](https://github.com/mgermerie/itowns/commit/0491983))
* **bundle:** add doc to use the bundles ESM and UMD ([60a9465](https://github.com/mgermerie/itowns/commit/60a9465))
* **ColorLayer:** rewrote ambiguous documentation ([fd85969](https://github.com/mgermerie/itowns/commit/fd85969))
* **contributors:** add Tim Ebben ([b65d8ae](https://github.com/mgermerie/itowns/commit/b65d8ae))
* **Coordinates:** update and refine documentation ([6cb7416](https://github.com/mgermerie/itowns/commit/6cb7416))
* **Ellipsoid:** update and refine documentation ([f922530](https://github.com/mgermerie/itowns/commit/f922530))
* **Extent:** update and refine documentation ([965c2ea](https://github.com/mgermerie/itowns/commit/965c2ea))
...
* **OrientationUtils:** update and refine documentation ([4ac60cd](https://github.com/mgermerie/itowns/commit/4ac60cd))
* remove empty class used for documentation ([9479973](https://github.com/mgermerie/itowns/commit/9479973))
* rewrite some docs to follow jsdoc semantics ([cbb1b96](https://github.com/mgermerie/itowns/commit/cbb1b96))
* **test:** update command to run one functional test ([c862ca7](https://github.com/mgermerie/itowns/commit/c862ca7))
* **TileMesh:** update and refine documentation ([0e90f3e](https://github.com/mgermerie/itowns/commit/0e90f3e))
* **Tile:** update and refine documentation ([bb69004](https://github.com/mgermerie/itowns/commit/bb69004))
...
* **hooks_functional:** fix message when page errors ([9817605](https://github.com/mgermerie/itowns/commit/9817605))
* **lasparser:** add test for parseChunk ([50a17a6](https://github.com/mgermerie/itowns/commit/50a17a6))
...
* **VectorTileSource:** fix test ([a80b95f](https://github.com/mgermerie/itowns/commit/a80b95f))
* **vpc:** add unit tests ([8de95be](https://github.com/mgermerie/itowns/commit/8de95be))


### Others

* 2.47.1-next.0 ([3d788dc](https://github.com/mgermerie/itowns/commit/3d788dc))
...
<a name="2.47.1-next.0"></a>
## [2.47.1-next.0](https://github.com/mgermerie/itowns/compare/v2.46.0...v2.47.1-next.0) (2026-01-09)
