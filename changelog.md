...
* release v2.39.0 ([504d17a](https://github.com/iTowns/itowns/commit/504d17a))
...
* **integration:** differentiate deployment for LTS and current version ([0f5f355](https://github.com/iTowns/itowns/commit/0f5f355))
* **integration:** publish latest and next npm packages ([af2c48e](https://github.com/iTowns/itowns/commit/af2c48e))
...
* [TEMP] test publication and deployment on personal repos ([3e9e89f](https://github.com/iTowns/itowns/commit/3e9e89f))
* add version switch on templates ([0156709](https://github.com/iTowns/itowns/commit/0156709))
